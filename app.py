...
data_all = loadData('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/data_appli.pickle')
data_string=loadData('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/string_values.pickle')
scaler = loadData('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/scaler.pickle')
XGB_clf = loadData('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/XGB_clf.pickle')
...
def insertPersonnalInformations(list_features,list_features_real):
    ...
    type_contrat = st.selectbox("Type of Contract",data_string.NAME_CONTRACT_TYPE.drop_duplicates())
    ...
    statut_marital = st.selectbox("Marital Status",data_string.NAME_FAMILY_STATUS.drop_duplicates())
    ...
    type_bien = st.selectbox("Housing type",data_string.NAME_HOUSING_TYPE.drop_duplicates())
    ...
    type_societé = st.selectbox("Organization Type",type_org)
    ...
    type_post = st.selectbox("Occupation Type ",type_emploi)
...
def runInsertPersonnalInformations():
    ...
    with open('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/arr_output.pickle','wb') as handle:
        pickle.dump(arr, handle, protocol=pickle.HIGHEST_PROTOCOL)
    with open('/Users/Karim/Desktop/Data_Science/Projets/Projet_07/P7_Yahiatene_Karim/arr_output_str.pickle','wb') as handle:
